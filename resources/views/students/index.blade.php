                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="border py-2 px-4 text-center">
                                <div class="flex justify-center">
                                    ...
                                    <button type="button" onclick="confirmDelete('{{ $student->id }}')" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 focus:outline-none focus:bg-red-600">Delete</button>
                                </div>
